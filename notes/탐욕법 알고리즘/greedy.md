...
* 거스름 돈 문제는 전형작인 탐욕 알고리즘의 예시다.
* 카운터에 500, 100원, 50원, 10원짜리 동전이 무수히 많이 존재한다.
...
- 거스름 돈 문제의 해법은 다음과 같다.
  ...
  현재 금액: 6480원 / 남은 금액: 480원
- 현재까지 사용한 동전 수: 12개
  [2단계] 100원으로 거슬러 줄 수 있는 만큼 거슬러 준다.
  현재 금액: 480원 / 남은 금액: 80원
